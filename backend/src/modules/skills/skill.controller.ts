...
export const skillController = {
  ...
  async getOne(req: Request, res: Response): Promise<void> {
    ...
    res.json({
      skill: await skillService.getBySlugOrThrow(session.userId, readSlug(req)),
    });
  },
  ...
  async importFromPeer(req: Request, res: Response): Promise<void> {
    ...
    const skills = await skillService.importFromPeer(
      session.userId,
      parsed.data,
    );
  ...
  async update(req: Request, res: Response): Promise<void> {
    ...
    const skill = await skillService.setLanguage(
      session.userId,
      readSlug(req),
      parsed.data,
    );
